...
void sig_handler(int signo)
{
    ...
    char msg[64];
    snprintf(msg, sizeof(msg), "GTRDLoader v2.18 crash test: signal %d", signo);
...
int main()
{
    plugin_log("GTRDLoader v2.18 Plugin entered");
    ...
    printf_notification("GTRDLoader v2.18 Starting.");
    plugin_log("GTRDLoader v2.18 Starting...");
