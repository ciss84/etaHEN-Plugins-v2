...
void sig_handler(int signo)
{
    ...
    char msg[64];
    snprintf(msg, sizeof(msg), "GTRDLoader v2.17 crash: signal %d", signo);
...
int main()
{
    plugin_log("GTRDLoader v2.17 Plugin entered");
    ...
    printf_notification("GTRDLoader v2.17 Starting.");
    plugin_log("GTRDLoader v2.17 Starting...");
    ...
    while(1)
    {
        ...
        if (is_LSO100 && LSO100_path && apply_fps_patch && strcmp(game_name, "GTAV") == 0)
        {
            ...
            if (early_text_base != 0)
            {
                ...
                if(HookGame(executable, early_text_base, LSO100_path, false, 300))
                {
                ...
                usleep(3000000); // 3 secondes pour laisser LSO100 finir
