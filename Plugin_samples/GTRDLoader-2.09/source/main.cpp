...
void sig_handler(int signo)
{
    ...
    char msg[64];
    snprintf(msg, sizeof(msg), "GTA5RDR2Loader v2.09 crash: signal %d", signo);
...
int main()
{
    plugin_log("GTRDLoader v2.09 Plugin entered");
    ...
    printf_notification("GTRDLoader v2.09 Starting.");
    plugin_log("GTRDLoader v2.09 Starting...");
